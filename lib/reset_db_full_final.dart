...
Future<void> resetDatabase() async {
  ...
  final List<String> inserts = [
    ...
    // REVIEWS
    "INSERT INTO Review (id_profile, title_review, title_book, author_review, author_book, content, image_path) VALUES (8, 'O direito de ganhar mais rapidamente', 'O direito de avançar mais rapidamente', 'Elisa Ribeiro', 'Clara Santos', 'Uma leitura envolvente do início ao fim. Recomendo para quem gosta de suspense.', 'images/review_8.jpg');",
    "INSERT INTO Review (id_profile, title_review, title_book, author_review, author_book, content, image_path) VALUES (7, 'A liberdade de realizar seus sonhos com toda a tranquilidade', 'O conforto de inovar mais rapidamente', 'Milena Moura', 'Vinicius Vieira', 'O autor desenvolve bem os personagens e o enredo prende muito.', 'images/review_9.jpg');",
    "INSERT INTO Review (id_profile, title_review, title_book, author_review, author_book, content, image_path) VALUES (8, 'A liberdade de inovar mais facilmente', 'A possibilidade de atingir seus objetivos em estado puro', 'Elisa Ribeiro', 'Carlos Eduardo Cardoso', 'Um dos melhores livros que li esse ano. Final surpreendente!', 'images/review_10.jpg');",
    "INSERT INTO Review (id_profile, title_review, title_book, author_review, author_book, content, image_path) VALUES (3, 'A arte de realizar seus sonhos naturalmente', 'A simplicidade de evoluir mais facilmente', 'Sr. João Lucas Moraes', 'Alice da Luz', 'A escrita é fluida e os capítulos curtos tornam a leitura rápida.', 'images/review_11.jpg');",
    "INSERT INTO Review (id_profile, title_review, title_book, author_review, author_book, content, image_path) VALUES (5, 'A certeza de ganhar direto da fonte', 'A liberdade de realizar seus sonhos antes de tudo', 'Alana Correia', 'Carlos Eduardo Ferreira', 'Tema atual e necessário. Uma narrativa tocante e bem construída.', 'images/review_12.jpg');",
