...
class _ChatState extends State<Chat> {
  ...
  final List<String> _filterOptions = ['Contatos', 'Grupos'];
  ...
  Future<void> _loadSearchHistory() async {
    ...
    setState(() {
      _searchHistory = prefs.getStringList('chatSearchHistory') ?? [];
    });
  }
  ...
  Future<void> _saveSearch(String query) async {
    ...
    await prefs.setStringList('chatSearchHistory', _searchHistory);
    setState(() {});
  }
  ...
  void _clearHistory() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.remove('chatSearchHistory');
    setState(() {
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Pesquisar contatos/grupos...',
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: Icon(
                          filter == 'Grupos' ? Icons.group : Icons.person,
